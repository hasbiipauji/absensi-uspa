    ...
    <form action="{{ route('absensi.store') }}" method="post">
        @csrf
          ...
          <div class=" col-sm-12 d-flex btn-group-toggle" data-toggle="buttons">
                <label onclick="handleClick(2);"  class=" m-auto btn btn-success" id="label_absen_1">
                  <input  type="radio" name="status" id="option1" value="hadir" required> Hadir
                </label>
                <label onclick="handleClick(3);"  class=" m-auto btn btn-warning" id="label_absen_1">
                  <input  type="radio" name="status" id="option2" value="izin"> Izin
                </label>
                <label onclick="handleClick(4);"  class=" m-auto btn btn-danger" id="label_absen_1">
