...
<div class="container mt-5">
    <div class="row">
    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 shadow-lg p-3 mb-5 bg-white rounded" style="background-color:#B0B0B0">
        <div class="login-brand">
        <img src="{{ asset('assets/img/uspa.png') }}" alt="logo" width="60">
        </div>
